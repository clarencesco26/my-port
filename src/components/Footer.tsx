        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-12">
            ...
            <nav className="flex flex-col space-y-3">
              {navLinks.map((link) => (
                <button
                  ...
                  className="text-[#CCCCCC] hover:text-[#E4002B] transition-all duration-300 relative group text-left"
                  style={{
                ...
                >
                  <span className="relative">
                    {link}
                    <span 
                      className="absolute -bottom-0.5 left-0 w-0 h-px bg-[#E4002B] transition-all duration-300 group-hover:w-full"
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/clarence.escoto"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-[#E4002B] transition-all duration-300 transform hover:scale-110"
                style={{
                  filter: 'drop-shadow(0 0 0 transparent)',
                }}
                onMouseEnter={e => {
                  e.currentTarget.style.filter = `drop-shadow(0 0 5px #E4002B)`;
                  e.currentTarget.style.color = '#E4002B';
                }}
                onMouseLeave={e => {
              ...
              <a
                href="https://www.instagram.com/_wtfvckclarence"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-[#E4002B] transition-all duration-300 transform hover:scale-110"
                style={{
